...
/* even more winetricks verbs (100 prefix helpers) */
WINK_SIMPLE_VERB(prefix_helper1, "prefix_helper1")
WINK_SIMPLE_VERB(prefix_helper2, "prefix_helper2")
WINK_SIMPLE_VERB(prefix_helper3, "prefix_helper3")
WINK_SIMPLE_VERB(prefix_helper4, "prefix_helper4")
WINK_SIMPLE_VERB(prefix_helper5, "prefix_helper5")
WINK_SIMPLE_VERB(prefix_helper6, "prefix_helper6")
WINK_SIMPLE_VERB(prefix_helper7, "prefix_helper7")
WINK_SIMPLE_VERB(prefix_helper8, "prefix_helper8")
WINK_SIMPLE_VERB(prefix_helper9, "prefix_helper9")
WINK_SIMPLE_VERB(prefix_helper10, "prefix_helper10")
WINK_SIMPLE_VERB(prefix_helper11, "prefix_helper11")
WINK_SIMPLE_VERB(prefix_helper12, "prefix_helper12")
WINK_SIMPLE_VERB(prefix_helper13, "prefix_helper13")
WINK_SIMPLE_VERB(prefix_helper14, "prefix_helper14")
WINK_SIMPLE_VERB(prefix_helper15, "prefix_helper15")
WINK_SIMPLE_VERB(prefix_helper16, "prefix_helper16")
WINK_SIMPLE_VERB(prefix_helper17, "prefix_helper17")
WINK_SIMPLE_VERB(prefix_helper18, "prefix_helper18")
WINK_SIMPLE_VERB(prefix_helper19, "prefix_helper19")
WINK_SIMPLE_VERB(prefix_helper20, "prefix_helper20")
WINK_SIMPLE_VERB(prefix_helper21, "prefix_helper21")
WINK_SIMPLE_VERB(prefix_helper22, "prefix_helper22")
WINK_SIMPLE_VERB(prefix_helper23, "prefix_helper23")
WINK_SIMPLE_VERB(prefix_helper24, "prefix_helper24")
WINK_SIMPLE_VERB(prefix_helper25, "prefix_helper25")
WINK_SIMPLE_VERB(prefix_helper26, "prefix_helper26")
WINK_SIMPLE_VERB(prefix_helper27, "prefix_helper27")
WINK_SIMPLE_VERB(prefix_helper28, "prefix_helper28")
WINK_SIMPLE_VERB(prefix_helper29, "prefix_helper29")
WINK_SIMPLE_VERB(prefix_helper30, "prefix_helper30")
WINK_SIMPLE_VERB(prefix_helper31, "prefix_helper31")
WINK_SIMPLE_VERB(prefix_helper32, "prefix_helper32")
WINK_SIMPLE_VERB(prefix_helper33, "prefix_helper33")
WINK_SIMPLE_VERB(prefix_helper34, "prefix_helper34")
WINK_SIMPLE_VERB(prefix_helper35, "prefix_helper35")
WINK_SIMPLE_VERB(prefix_helper36, "prefix_helper36")
WINK_SIMPLE_VERB(prefix_helper37, "prefix_helper37")
WINK_SIMPLE_VERB(prefix_helper38, "prefix_helper38")
WINK_SIMPLE_VERB(prefix_helper39, "prefix_helper39")
WINK_SIMPLE_VERB(prefix_helper40, "prefix_helper40")
WINK_SIMPLE_VERB(prefix_helper41, "prefix_helper41")
WINK_SIMPLE_VERB(prefix_helper42, "prefix_helper42")
WINK_SIMPLE_VERB(prefix_helper43, "prefix_helper43")
WINK_SIMPLE_VERB(prefix_helper44, "prefix_helper44")
WINK_SIMPLE_VERB(prefix_helper45, "prefix_helper45")
WINK_SIMPLE_VERB(prefix_helper46, "prefix_helper46")
WINK_SIMPLE_VERB(prefix_helper47, "prefix_helper47")
WINK_SIMPLE_VERB(prefix_helper48, "prefix_helper48")
WINK_SIMPLE_VERB(prefix_helper49, "prefix_helper49")
WINK_SIMPLE_VERB(prefix_helper50, "prefix_helper50")
WINK_SIMPLE_VERB(prefix_helper51, "prefix_helper51")
WINK_SIMPLE_VERB(prefix_helper52, "prefix_helper52")
WINK_SIMPLE_VERB(prefix_helper53, "prefix_helper53")
WINK_SIMPLE_VERB(prefix_helper54, "prefix_helper54")
WINK_SIMPLE_VERB(prefix_helper55, "prefix_helper55")
WINK_SIMPLE_VERB(prefix_helper56, "prefix_helper56")
WINK_SIMPLE_VERB(prefix_helper57, "prefix_helper57")
WINK_SIMPLE_VERB(prefix_helper58, "prefix_helper58")
WINK_SIMPLE_VERB(prefix_helper59, "prefix_helper59")
WINK_SIMPLE_VERB(prefix_helper60, "prefix_helper60")
WINK_SIMPLE_VERB(prefix_helper61, "prefix_helper61")
WINK_SIMPLE_VERB(prefix_helper62, "prefix_helper62")
WINK_SIMPLE_VERB(prefix_helper63, "prefix_helper63")
WINK_SIMPLE_VERB(prefix_helper64, "prefix_helper64")
WINK_SIMPLE_VERB(prefix_helper65, "prefix_helper65")
WINK_SIMPLE_VERB(prefix_helper66, "prefix_helper66")
WINK_SIMPLE_VERB(prefix_helper67, "prefix_helper67")
WINK_SIMPLE_VERB(prefix_helper68, "prefix_helper68")
WINK_SIMPLE_VERB(prefix_helper69, "prefix_helper69")
WINK_SIMPLE_VERB(prefix_helper70, "prefix_helper70")
WINK_SIMPLE_VERB(prefix_helper71, "prefix_helper71")
WINK_SIMPLE_VERB(prefix_helper72, "prefix_helper72")
WINK_SIMPLE_VERB(prefix_helper73, "prefix_helper73")
WINK_SIMPLE_VERB(prefix_helper74, "prefix_helper74")
WINK_SIMPLE_VERB(prefix_helper75, "prefix_helper75")
WINK_SIMPLE_VERB(prefix_helper76, "prefix_helper76")
WINK_SIMPLE_VERB(prefix_helper77, "prefix_helper77")
WINK_SIMPLE_VERB(prefix_helper78, "prefix_helper78")
WINK_SIMPLE_VERB(prefix_helper79, "prefix_helper79")
WINK_SIMPLE_VERB(prefix_helper80, "prefix_helper80")
WINK_SIMPLE_VERB(prefix_helper81, "prefix_helper81")
WINK_SIMPLE_VERB(prefix_helper82, "prefix_helper82")
WINK_SIMPLE_VERB(prefix_helper83, "prefix_helper83")
WINK_SIMPLE_VERB(prefix_helper84, "prefix_helper84")
WINK_SIMPLE_VERB(prefix_helper85, "prefix_helper85")
WINK_SIMPLE_VERB(prefix_helper86, "prefix_helper86")
WINK_SIMPLE_VERB(prefix_helper87, "prefix_helper87")
WINK_SIMPLE_VERB(prefix_helper88, "prefix_helper88")
WINK_SIMPLE_VERB(prefix_helper89, "prefix_helper89")
WINK_SIMPLE_VERB(prefix_helper90, "prefix_helper90")
WINK_SIMPLE_VERB(prefix_helper91, "prefix_helper91")
WINK_SIMPLE_VERB(prefix_helper92, "prefix_helper92")
WINK_SIMPLE_VERB(prefix_helper93, "prefix_helper93")
WINK_SIMPLE_VERB(prefix_helper94, "prefix_helper94")
WINK_SIMPLE_VERB(prefix_helper95, "prefix_helper95")
WINK_SIMPLE_VERB(prefix_helper96, "prefix_helper96")
WINK_SIMPLE_VERB(prefix_helper97, "prefix_helper97")
WINK_SIMPLE_VERB(prefix_helper98, "prefix_helper98")
WINK_SIMPLE_VERB(prefix_helper99, "prefix_helper99")
WINK_SIMPLE_VERB(prefix_helper100, "prefix_helper100")

/* yet more winetricks verbs (50 extra tools) */
WINK_SIMPLE_VERB(extra_tool1, "extra_tool1")
WINK_SIMPLE_VERB(extra_tool2, "extra_tool2")
WINK_SIMPLE_VERB(extra_tool3, "extra_tool3")
WINK_SIMPLE_VERB(extra_tool4, "extra_tool4")
WINK_SIMPLE_VERB(extra_tool5, "extra_tool5")
WINK_SIMPLE_VERB(extra_tool6, "extra_tool6")
WINK_SIMPLE_VERB(extra_tool7, "extra_tool7")
WINK_SIMPLE_VERB(extra_tool8, "extra_tool8")
WINK_SIMPLE_VERB(extra_tool9, "extra_tool9")
WINK_SIMPLE_VERB(extra_tool10, "extra_tool10")
WINK_SIMPLE_VERB(extra_tool11, "extra_tool11")
WINK_SIMPLE_VERB(extra_tool12, "extra_tool12")
WINK_SIMPLE_VERB(extra_tool13, "extra_tool13")
WINK_SIMPLE_VERB(extra_tool14, "extra_tool14")
WINK_SIMPLE_VERB(extra_tool15, "extra_tool15")
WINK_SIMPLE_VERB(extra_tool16, "extra_tool16")
WINK_SIMPLE_VERB(extra_tool17, "extra_tool17")
WINK_SIMPLE_VERB(extra_tool18, "extra_tool18")
WINK_SIMPLE_VERB(extra_tool19, "extra_tool19")
WINK_SIMPLE_VERB(extra_tool20, "extra_tool20")
WINK_SIMPLE_VERB(extra_tool21, "extra_tool21")
WINK_SIMPLE_VERB(extra_tool22, "extra_tool22")
WINK_SIMPLE_VERB(extra_tool23, "extra_tool23")
WINK_SIMPLE_VERB(extra_tool24, "extra_tool24")
WINK_SIMPLE_VERB(extra_tool25, "extra_tool25")
WINK_SIMPLE_VERB(extra_tool26, "extra_tool26")
WINK_SIMPLE_VERB(extra_tool27, "extra_tool27")
WINK_SIMPLE_VERB(extra_tool28, "extra_tool28")
WINK_SIMPLE_VERB(extra_tool29, "extra_tool29")
WINK_SIMPLE_VERB(extra_tool30, "extra_tool30")
WINK_SIMPLE_VERB(extra_tool31, "extra_tool31")
WINK_SIMPLE_VERB(extra_tool32, "extra_tool32")
WINK_SIMPLE_VERB(extra_tool33, "extra_tool33")
WINK_SIMPLE_VERB(extra_tool34, "extra_tool34")
WINK_SIMPLE_VERB(extra_tool35, "extra_tool35")
WINK_SIMPLE_VERB(extra_tool36, "extra_tool36")
WINK_SIMPLE_VERB(extra_tool37, "extra_tool37")
WINK_SIMPLE_VERB(extra_tool38, "extra_tool38")
WINK_SIMPLE_VERB(extra_tool39, "extra_tool39")
WINK_SIMPLE_VERB(extra_tool40, "extra_tool40")
WINK_SIMPLE_VERB(extra_tool41, "extra_tool41")
WINK_SIMPLE_VERB(extra_tool42, "extra_tool42")
WINK_SIMPLE_VERB(extra_tool43, "extra_tool43")
WINK_SIMPLE_VERB(extra_tool44, "extra_tool44")
WINK_SIMPLE_VERB(extra_tool45, "extra_tool45")
WINK_SIMPLE_VERB(extra_tool46, "extra_tool46")
WINK_SIMPLE_VERB(extra_tool47, "extra_tool47")
WINK_SIMPLE_VERB(extra_tool48, "extra_tool48")
WINK_SIMPLE_VERB(extra_tool49, "extra_tool49")
WINK_SIMPLE_VERB(extra_tool50, "extra_tool50")
