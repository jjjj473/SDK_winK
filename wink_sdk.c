...
WINK_SIMPLE_VERB(install_dotnet20, "dotnet20")
WINK_SIMPLE_VERB(install_dotnet30, "dotnet30")
WINK_SIMPLE_VERB(install_dotnet40, "dotnet40")
WINK_SIMPLE_VERB(install_dotnet45, "dotnet45")
WINK_SIMPLE_VERB(install_dotnet46, "dotnet46")
WINK_SIMPLE_VERB(install_dotnet461, "dotnet461")
WINK_SIMPLE_VERB(install_dotnet462, "dotnet462")
WINK_SIMPLE_VERB(install_dotnet471, "dotnet471")
WINK_SIMPLE_VERB(install_dotnet472, "dotnet472")
WINK_SIMPLE_VERB(install_vcrun2017, "vcrun2017")
WINK_SIMPLE_VERB(install_vcrun2019, "vcrun2019")
WINK_SIMPLE_VERB(install_vcrun2022, "vcrun2022")
WINK_SIMPLE_VERB(install_wmp10, "wmp10")
WINK_SIMPLE_VERB(install_wmp11, "wmp11")
WINK_SIMPLE_VERB(install_wsh56, "wsh56")
WINK_SIMPLE_VERB(install_wsh57, "wsh57")
WINK_SIMPLE_VERB(install_wsh60, "wsh60")
WINK_SIMPLE_VERB(install_wsh70, "wsh70")
WINK_SIMPLE_VERB(install_wsh72, "wsh72")
WINK_SIMPLE_VERB(install_faudio, "faudio")
WINK_SIMPLE_VERB(install_xna40, "xna40")
WINK_SIMPLE_VERB(install_d3dx9_28, "d3dx9_28")
WINK_SIMPLE_VERB(install_d3dx9_29, "d3dx9_29")
WINK_SIMPLE_VERB(install_d3dx9_30, "d3dx9_30")
WINK_SIMPLE_VERB(install_d3dx9_31, "d3dx9_31")
WINK_SIMPLE_VERB(install_d3dx9_32, "d3dx9_32")
WINK_SIMPLE_VERB(install_d3dx9_33, "d3dx9_33")
WINK_SIMPLE_VERB(install_d3dx9_34, "d3dx9_34")
WINK_SIMPLE_VERB(install_d3dx9_35, "d3dx9_35")
WINK_SIMPLE_VERB(install_d3dx9_36, "d3dx9_36")
WINK_SIMPLE_VERB(install_d3dx9_37, "d3dx9_37")
WINK_SIMPLE_VERB(install_d3dx9_38, "d3dx9_38")
WINK_SIMPLE_VERB(install_d3dx9_39, "d3dx9_39")
WINK_SIMPLE_VERB(install_d3dx9_40, "d3dx9_40")
WINK_SIMPLE_VERB(install_d3dx9_41, "d3dx9_41")
WINK_SIMPLE_VERB(install_d3dx9_42, "d3dx9_42")
WINK_SIMPLE_VERB(install_d3dx9_43, "d3dx9_43")
WINK_SIMPLE_VERB(install_ie6, "ie6")
WINK_SIMPLE_VERB(install_ie7, "ie7")
WINK_SIMPLE_VERB(install_ie8, "ie8")
WINK_SIMPLE_VERB(install_quicktime, "quicktime")
WINK_SIMPLE_VERB(install_xvid, "xvid")
WINK_SIMPLE_VERB(install_wmv9vcm, "wmv9vcm")
WINK_SIMPLE_VERB(install_l3codecx, "l3codecx")
WINK_SIMPLE_VERB(install_mdac27, "mdac27")
WINK_SIMPLE_VERB(install_mdac28, "mdac28")
WINK_SIMPLE_VERB(install_msls31, "msls31")
WINK_SIMPLE_VERB(install_dinput8, "dinput8")
WINK_SIMPLE_VERB(install_dinput, "dinput")
WINK_SIMPLE_VERB(install_dxdiag, "dxdiag")
