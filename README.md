...
The SDK exposes many helpers for common Wine tasks (over three hundred fifty in total). These wrappers execute real winetricks verbs to automate prefix setup. Some examples include:
